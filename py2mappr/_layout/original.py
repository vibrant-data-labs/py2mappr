...
class OriginalLayout(Layout):
    def __init__(self, project, settings = original_base_settings, x_axis = "X", y_axis = "Y", name=None, subtitle=None, image=None):
        super().__init__(settings, "original", x_axis, y_axis, name, subtitle, image)
