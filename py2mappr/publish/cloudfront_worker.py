...
def cloudfront_worker(bucket: str, url: str):
    ...
    bucket_website = '%s.s3-website-%s.amazonaws.com' % (
        bucket, REGION)
    ...
    for distribution in distributions['DistributionList']['Items']:
        if distribution['Aliases']['Items'][0] == url \
                and distribution['Origins']['Items'][0]['DomainName'] == bucket_website:
    ...
    print('Distribution created: %s' % response.get('Distribution').get('DomainName'))
